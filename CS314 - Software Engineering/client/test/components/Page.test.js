...
describe('Page', () => {
	...
	it('leeann23: check if Cumulative text displays', async () => {
		screen.getByText('Cumulative');
	});

	it('leeann23: check if Miles text displays', async () => {
		screen.getByText('Miles');
	});

	it('leeann23: check if Total Distance text displays', async () => {
		screen.getByText('Total Distance: 0');
	});
});
