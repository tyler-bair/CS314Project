...
import com.tco.requests.gameManagement.InformationRequest;
import com.tco.requests.gamePlaying.MoveRequest;
import com.tco.requests.UnRegisterRequest;
...
public final class MicroServer {
    ...
    private void processRestfulAPIrequests() {
        path("/api", () -> {
            ...
            post("/info", (req, res) -> processHttpRequest(req, res, InformationRequest.class));
            post("/login", (req, res) -> processHttpRequest(req, res, LoginRequest.class));
            post("/unregister", (req, res) -> processHttpRequest(req, res, UnRegisterRequest.class));
            post("/match", (req, res) -> processHttpRequest(req, res, ManageMatchRequest.class));
